...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary"> Create Invoice </h3> </div>
...
for any PHP, Codeignitor or Laravel work visit www.mayurik.com  -->
    ...
    <div class="col-sm-4">
        <input type="text" id="clientName" class="form-control" name="clientName" placeholder="Client Name" autocomplete="off" onkeyup="getSuggestions(this.value)">
...
<script>
    ...
    // Function to set input value when a suggestion is clicked
    function setSuggestionValue(name, contact) {
        document.getElementById("clientName").value = name;
        document.getElementById("clientContact").value = contact; // Set client contact
